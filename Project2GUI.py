...
menu = ["Home", "Student Login", "Student Search", "About us"]
...
# Merge the dataframes on 'CourseName' to include all details
    ...
    st.subheader('A job is worth doing together')

    # Introduction text
    st.write('Meet the dedicated team at Loom, revolutionizing the way we farm with innovative, beautiful, and sustainable solutions for the home.')

    # Team Members
    col1, col2 = st.columns(2, gap = "large")

    with col1:
        st.image('quyen_final.jpg')
        st.markdown("<h2 style='text-align: center;'>Tran Yen Quyen</h2>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center;'>Develop the model and GUI</p>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center;'><a href='https://www.linkedin.com/in/tranyenquyen/'>LinkedIn Profile</a></p>", unsafe_allow_html=True)

    with col2:
        st.image('dang_final.jpg')
        st.markdown("<h2 style='text-align: center;'>Nguyen Ha Dang</h2>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center;'>Develop the model</p>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center;'><a href='https://www.linkedin.com/in/tranyenquyen/'>LinkedIn Profile</a></p>", unsafe_allow_html=True)
    
    st.write("-----------------------------------------------------------------------------------------------")
    st.subheader("Explain the model in the application")
    
    st.write("#### Project Introduction")
    st.write("A recommendation system is a type of information filtering system that seeks to predict and show the preferences a user would give to an item or product. These systems are prevalent in various industries and applications, primarily aiming to personalize the user experience and suggest items that are most relevant to the user.")
    
    st.write("#### Target")
    st.markdown("""
- **Enhanced User Experience:** By providing personalized content, recommendation systems improve user satisfaction and engagement.
- **Increased Sales and Revenue:** These systems can effectively upsell and cross-sell by introducing users to products they may not have discovered otherwise.
- **Customer Retention:** Personalized experiences keep users coming back for more, which is vital for long-term success in competitive markets.
""")
    
    st.write("#### Business Introduction")
    st.markdown("""
- Coursera is an online education platform established in 2012 by two computer science professors from Stanford University, Andrew Ng and Daphne Koller.
- Coursera partners with over 275 leading universities and companies to offer courses, professional certificates, and online degrees in various fields.
""")
    st.write("#### How we build the project")
    st.image('project steps.jpg', caption='How we work on this project')
    st.write("#### CONTENT BASED FILTERING")
    st.write("Use cases: Provide courses recommendations when Users use keywords or Users view top courses.")
    st.write("As a Python library specializing in determining semantic similarity between two documents through vector space models and a topic modeling toolkit, the main idea of this method is to make recommendations based on the similarity between products.")
    st.write("**Output**")
    st.image('searchkey-output.jpg', caption='Output using searchkey')
    st.image('topcourse_output.jpg', caption='Output when users view top courses')
    
    st.write("#### COLLABORATIVE FILTERING")
    st.write("Use cases: Provide courses recommendations for specific users.")
    st.write("The Alternating Least Squares (ALS) model is a popular algorithm used primarily for collaborative filtering in recommendation systems. This model aims to predict user preferences for items by decomposing the large user-item interaction matrix into lower-dimensional matrices, representing latent factors associated with users and items.")
    st.write("**Output**")
    st.image('login-output.jpg', caption='Output when users log in into their account')
